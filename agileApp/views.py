    ...
    if staff:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                flujoestado = request.POST.get('estado', None)
                if flujoestado:
                    results = results.filter(estado__icontains=flujoestado)
                
                            
                
                if not flujoid and not flujodescripcion and not flujonombre and not flujoestado:
                    results = None
